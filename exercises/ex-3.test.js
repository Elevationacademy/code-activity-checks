...
describe('exercise3', () => {
  ...
  it("The LeaderBoard component should render the players array (passed from App's state) sorted by their scores", () => {
    let firstPlayerDetails = wrapper.find('.leaderboard').find('tbody').children().at(1).html()
    expect(
      firstPlayerDetails,
    ...
    let secondPlayerDetails = wrapper.find('.leaderboard').find('tbody').children().at(2).html()
    expect(
      secondPlayerDetails,
      `When given a players' array of [
        { id: 1, name: 'Jona', score: 100 },
    ...
    let thirdPlayerDetails = wrapper.find('.leaderboard').find('tbody').children().at(3).html()
    expect(
      thirdPlayerDetails,
      `When given a players' array of [
        { id: 1, name: 'Jona', score: 100 },
